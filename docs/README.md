...
This folder contains Friink’s product and engineering documentation.
...
Unit documents describe product boundaries, ownership, related areas, UX and
flows, business rules, technical contracts, acceptance criteria, testing,
limitations, implementation status, and rebuild guidance.
