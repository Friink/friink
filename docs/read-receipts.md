...
- Double grey ticks mean the recipient's open conversation fetched the message.
...
- Delivery is recorded only when the full conversation message endpoint fetches the
  message, not when a background conversation-list refresh fetches a preview.
