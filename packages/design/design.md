...
3. **Header (Global Utilities)**:
   ...
   - Chat (`fa-regular fa-comment` → `/chats`) sits between Search and Notifications and shows a green dot when any conversation has unread messages; activating it opens the Chat list.
