...
class RefreshToken(Base):
    ...
    __table_args__ = (Index("ix_refresh_tokens_family_active", "family_id", "revoked_at", "expires_at"),)
    ...
    reuse_grace_used_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
