...
def upgrade() -> None:
    ...
    op.create_table("plan_entitlements", sa.Column("plan_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("plans.id", ondelete="CASCADE"), primary_key=True), sa.Column("entitlement_key", sa.String(100), primary_key=True))
